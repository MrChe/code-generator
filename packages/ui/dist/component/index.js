...
module.exports = {
    ...
    actions: (data) => {
        ...
        const actions = [
            {
                type: 'add',
                path: `${process.cwd()}/src/{{properCase name}}/{{properCase name}}.js`,
                templateFile: componentTemplate,
                abortOnFail: true,
            },
            {
                type: 'add',
                path: `${process.cwd()}/src/{{properCase name}}/index.js`,
                templateFile: path.resolve(__dirname, './index.js.hbs'),
                abortOnFail: true,
            },
            {
                type: 'add',
                path: `${process.cwd()}/src/{{properCase name}}/styles/{{properCase name}}Styled.js`,
                templateFile: path.resolve(__dirname, './styled.js.hbs'),
                abortOnFail: true,
            }
        ];
        ...
        if (data.wantLoadable) {
            actions.push({
                type: 'add',
                path: `${process.cwd()}/src/{{properCase name}}/Loadable.js`,
        ...
        if (data.wantGenerateTests) {
            actions.push({
                type: 'add',
                path: `${process.cwd()}/src/components/{{properCase name}}/__test__/{{properCase name}}.test.js`,
